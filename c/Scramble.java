...
public class Scramble {
	 ...
	 * int intScrambles. since the method returns void it must be used with a new c.Scramble
	 ...
	 * a new c.Scramble object must be created which contains only the < 8 moves
	...
	/* this method iterates the c.Scramble according to the rules of toInt
	 * and fromInt, and also returns a c.Scramble which would transform a c.Cube
	 * from the previous c.Scramble to the current. this method will be used in
	 * iterating through possible scrambles in the solver. 
	 * this might not work over changes in c.Scramble size. */
	...
	//returns the c.Scramble inverse of the c.Scramble
	...
	/* changes the c.Scramble by a rotation / symmetry. a rotation is saved as
